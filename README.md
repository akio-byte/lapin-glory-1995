...
- **Events & narrative:** `src/data/gameData.ts` sisältää pelin `GameEvent`-pankin ja AI-faksit.
...
## Kehitysskriptit
- `npm run lint` varmistaa, että React-hook-säännöt ja TypeScript-tyylit pysyvät kurissa.
- `npm run gen:fax` generoi uudet AI-faksit `src/data/aiFaxEvents.ts`-tiedostoon.
